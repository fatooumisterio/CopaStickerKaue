...
export const teams = {
  ...
  RSA: { name: 'África do Sul', flag: '🇿🇦', color: '#007749', color2: '#FFB81C' },
  KOR: { name: 'Coreia do Sul', flag: '🇰🇷', color: '#C60C30', color2: '#0047A0' },
  CZE: { name: 'Tchéquia', flag: '🇨🇿', color: '#11457E', color2: '#D7141A' },

  CAN: { name: 'Canadá', flag: '🇨🇦', color: '#FF0000', color2: '#AA0000' },
  BIH: { name: 'Bósnia e Herzegovina', flag: '🇧🇦', color: '#002395', color2: '#FFCE00' },
  QAT: { name: 'Catar', flag: '🇶🇦', color: '#8A1538', color2: '#5C0E25' },
  SUI: { name: 'Suíça', flag: '🇨🇭', color: '#FF0000', color2: '#AA0000' },

  BRA: { name: 'Brasil', flag: '🇧🇷', color: '#009739', color2: '#FEDD00' },
  MAR: { name: 'Marrocos', flag: '🇲🇦', color: '#C1272D', color2: '#006233' },
  HAI: { name: 'Haiti', flag: '🇭🇹', color: '#00209F', color2: '#D21034' },
  SCO: { name: 'Escócia', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', color: '#0065BF', color2: '#004C8F' },

  USA: { name: 'Estados Unidos', flag: '🇺🇸', color: '#B31942', color2: '#0A3161' },
  PAR: { name: 'Paraguai', flag: '🇵🇾', color: '#D52B1E', color2: '#0038A8' },
  AUS: { name: 'Austrália', flag: '🇦🇺', color: '#00008B', color2: '#FF0000' },
  TUR: { name: 'Turquia', flag: '🇹🇷', color: '#E30A17', color2: '#AA0510' },

  GER: { name: 'Alemanha', flag: '🇩🇪', color: '#DD0000', color2: '#FFCC00' },
  CUW: { name: 'Curaçao', flag: '🇨🇼', color: '#002B7F', color2: '#F9E814' },
  CIV: { name: 'Costa do Marfim', flag: '🇨🇮', color: '#F77F00', color2: '#009E60' },
  ECU: { name: 'Equador', flag: '🇪🇨', color: '#FFDD00', color2: '#034EA2' },

  NED: { name: 'Holanda', flag: '🇳🇱', color: '#F36C21', color2: '#21468B' },
  JPN: { name: 'Japão', flag: '🇯🇵', color: '#000555', color2: '#BC002D' },
  SWE: { name: 'Suécia', flag: '🇸🇪', color: '#004B87', color2: '#FFCD00' },
  TUN: { name: 'Tunísia', flag: '🇹🇳', color: '#E70013', color2: '#AA000D' },

  BEL: { name: 'Bélgica', flag: '🇧🇪', color: '#E30613', color2: '#FFD900' },
  EGY: { name: 'Egito', flag: '🇪🇬', color: '#CE1126', color2: '#A30D1E' },
  IRN: { name: 'Irã', flag: '🇮🇷', color: '#239F40', color2: '#DA0000' },
  NZL: { name: 'Nova Zelândia', flag: '🇳🇿', color: '#000000', color2: '#FFFFFF' },

  ESP: { name: 'Espanha', flag: '🇪🇸', color: '#AA151B', color2: '#F1BF00' },
  CPV: { name: 'Cabo Verde', flag: '🇨🇻', color: '#003893', color2: '#CF0921' },
  KSA: { name: 'Arábia Saudita', flag: '🇸🇦', color: '#006C35', color2: '#004A24' },
  URU: { name: 'Uruguai', flag: '🇺🇾', color: '#0038A8', color2: '#FCD116' },

  FRA: { name: 'França', flag: '🇫🇷', color: '#002395', color2: '#ED2939' },
  SEN: { name: 'Senegal', flag: '🇸🇳', color: '#00853F', color2: '#FDEF42' },
  IRQ: { name: 'Iraque', flag: '🇮🇶', color: '#CE1126', color2: '#007A3D' },
  NOR: { name: 'Noruega', flag: '🇳🇴', color: '#BA0C2F', color2: '#00205B' },

  ARG: { name: 'Argentina', flag: '🇦🇷', color: '#43A1D5', color2: '#FFB81C' },
  ALG: { name: 'Argélia', flag: '🇩🇿', color: '#006233', color2: '#D21034' },
  AUT: { name: 'Áustria', flag: '🇦🇹', color: '#ED2939', color2: '#AA1E28' },
  JOR: { name: 'Jordânia', flag: '🇯🇴', color: '#CE1126', color2: '#007A3D' },

  POR: { name: 'Portugal', flag: '🇵🇹', color: '#FF0000', color2: '#006600' },
  COD: { name: 'RD Congo', flag: '🇨🇩', color: '#007FFF', color2: '#CE1021' },
  UZB: { name: 'Uzbequistão', flag: '🇺🇿', color: '#0099B5', color2: '#1EB53A' },
  COL: { name: 'Colômbia', flag: '🇨🇴', color: '#FCD116', color2: '#003893' },

  ENG: { name: 'Inglaterra', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', color: '#CF081F', color2: '#8C0514' },
  CRO: { name: 'Croácia', flag: '🇭🇷', color: '#FF0000', color2: '#0000FF' },
  GHA: { name: 'Gana', flag: '🇬🇭', color: '#CE1126', color2: '#FCD116' },
  PAN: { name: 'Panamá', flag: '🇵🇦', color: '#DA121A', color2: '#0038A8' },
